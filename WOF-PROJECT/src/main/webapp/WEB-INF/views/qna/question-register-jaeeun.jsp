...
<!-- End side nav -->
								...
								<div class="row">
									<div class="col-lg-6">
										 <div class="form-group">
											<label class="form-control-label" for="input-username">제목</label>
											<!-- quest_type => "0:, 1:, 2:, 3:" -->
											<input class="form-control" placeholder="제목" id="question_title">
										</div> 
									</div>
									<div class="col-lg-6">
										<div class="form-group">
											...
											<div class="form-control" name="real_name" readonly="readonly">
												<input type="hidden" id="real_name" value="${member.real_name}">
												${member.real_name}
											</div>
						...
						<div class="row"></div>
							...
							<div class="pl-lg-4">
								<div class="form-group">
									...
									<textarea rows="10" class="form-control" id="quest_contents"
	...
	$('#sedingEmail').click(function() {
		var vo = {
				quest_writer : $('#real_name').val(),
				quest_id : $('#userid').val(),
				quest_title : $('#question_title').val(),
				quest_userphone : $('#phoneNum').val(),
				quest_contents : $('#quest_contents').val()
		};
/* 		var name = $('#real_name').val();
		var title = $('#question_title').val();
		var phone = $('#phoneNum').val();
		var contents = $('#quest_contents').text(); */
		alert(vo.quest_writer + vo.quest_title + vo.quest_userphone + vo.quest_contents);
