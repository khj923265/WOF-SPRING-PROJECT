                    ...
                    <div class="block-23 mb-3">
                        <ul>
                            <li><span class="icon icon-map-marker"></span><span
                                    class="text">(08503) Gasan Digital 1-ro 181 Gasan Double U Center, Geumcheon-gu, Seoul, 3rd floor, 308-310, South Korea</span></li>
                            <li><a href="#"><span class="icon icon-phone"></span><span
                                    class="text">+02 6278 9352</span></a></li>
                            <li><a href="#"><span class="icon icon-envelope"></span><span
                                    class="text">https://edu.kosta.or.kr/</span></a></li>
                        </ul>
                    </div>
                </div>
            </div>
