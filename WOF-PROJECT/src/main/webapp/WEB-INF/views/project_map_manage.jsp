...
<title>project_map_manage.jsp</title>
...
<script type="text/javascript"
	src="//dapi.kakao.com/v2/maps/sdk.js?appkey=7701bcb1181323db8fa8e1b1b1e6c8e8&libraries=services"></script>
				...
				<div class="row">
					<div class="col-md-6">
						...
						<div>
							...
							<script type="text/javascript"
								src="//dapi.kakao.com/v2/maps/sdk.js?appkey=7701bcb1181323db8fa8e1b1b1e6c8e8"></script>
							<script>
								...
								var map1 = new kakao.maps.Map(mapContainer1,
										mapOption); // 지도를 생성합니다
					...
					<div class="col-md-6">
						...
						<div>
							<div class="map_wrap">
								<div id="map"
									style="width: 550px; height: 450px; position: relative; overflow: hidden;"></div>

								<div id="menu_wrap" class="bg_white">
									<div class="option">
										<div>
											<form onsubmit="searchPlaces(); return false;">
												키워드 : <input type="text" value="한국소프트웨어기술진흥협회" id="keyword"
													size="15">
