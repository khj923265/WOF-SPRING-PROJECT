							...
							<div class="row">
								<div class="col-xl-6">
										...
										<div class="row">
											...
											<div class="col">
												<span><input type="date" name="proj_apply_deadline"
													value="to_char(${project.getProj_apply_deadline()},'MM-dd-yyyy')"
													class="form-control" required></span>
											</div>
										</div>
										<!-- end row -->
										...
										<div class="row">
											<div class="col">
												<span><input type="date" name="proj_start_date"
													value="to_char(${project.getProj_start_date()},'MM-dd-yyyy')"
													class="form-control" required></span>
											</div>
											~
											<div class="col">
												<span><input type="date" name="proj_end_date"
													value="to_char(${project.getProj_end_date()},'MM-dd-yyyy')"
													class="form-control" required></span>
											</div>
											<div class="col">
										...
										<div class="row">
											<div class="col">
												<span><input type="text" name="proj_estimate"
													value="${project.getProj_estimate()}" class="form-control"
													placeholder="100,000" required></span>
											</div>
											<div class="col">
												<span>원</span>
											</div>
									...
									<div class="form-group">
										<label for="exampleFormControlSelect1">프로젝트 필요인원 <span
											...
											name="proj_reqr_person"
											value="${project.getProj_reqr_person()}" required>
											<option>1</option>
											<option>2</option>
											<option>3</option>
											<option>4</option>
									...
									<div class="form-group">
										...
										</select> <select class="form-control" name="proj_reqr_skill"
											value="${project.getProj_reqr_skill()}" required>
											<option>JSP</option>
											<option>PHP</option>
									...
									<div class="form-group">
										<label for="exampleFormControlSelect1">프로젝트 진행상태 <span
											class="required">*</span></label> <select class="form-control"
											name="proj_type" value="${project.getProj_type()}" required>
									...
									<div class="form-group">
										...
										<div class="custom-control custom-radio mb-3">
											<input type="radio" id="customRadio1" name="proj_pm"
												value="${project.getProj_pm()}" class="custom-control-input"
								...
								<div class="col-xl-6">
									...
									<div class="form-group">
										...
										<input type="text" name="proj_work_type"
											value="${project.getProj_work_type()}" class="form-control"
											placeholder="1 집 2 회사" required>
									</div>
	
									<div class="form-group">
										<label for="working_area">근무지역 <span class="required">*</span></label>
										<select class="form-control" name="proj_work_place"
											value="${project.getProj_work_place()}" required>
											<option>전국</option>
											<option>서울</option>
											<option>부산</option>
											<option>대구</option>
									...
									<div class="form-group">
										...
										<input type="text" name="proj_work_time"
											value="${project.getProj_work_time()}" class="form-control"
											placeholder="ex)월-금 9시-6시" required>
									</div>
									<div class="form-group">
										<label for="private_equip">개인장비 <span class="required">*</span></label>
										<input type="text" name="proj_work_equip"
											value="${project.getProj_work_equip()}" class="form-control"
											placeholder="1필수 2제공" required>
									</div>
									<div class="form-group">
										<label for="well_fare">복리후생 <span class="required">*</span></label>
										<input type="text" name="proj_walfare"
											value="${project.getProj_walfare()}" class="form-control"
