	...
	<%@ include file="../partners/menu.jsp"%>
		...
		<div class="container">
			...
			<form action="/point/paymentIn" method="post" name="paymentIn">
				<input type="hidden" name="business_register_no" value="3">
				<input type="hidden" name="contract_write_source" value="member90">
				<input type="hidden" name="point_amount" value="30000">
				<input type="hidden" name="point_contents" value="프로젝트 결제 test">
				
				<%-- <input type="hidden" name="business_register_no" value="${paymentIn.business_register_no }">
				<input type="hidden" name="contract_write_source" value="${paymentIn.member_no }">
				<input type="hidden" name="point_amount" value="${paymentIn.proj_estimate }">
				<input type="hidden" name="point_contents" value="${paymentIn.proj_title }"> --%>
				
				<div class="text-center">
				<input type="submit" class="btn btn-primary my-4" value="작성 완료">
			 	</div>
			</form>
			</div>
